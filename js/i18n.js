...
const translations = {
    bn: {
        ...
        "login.idLabel": "ফোন নম্বর",
        "login.idPlaceholder": "আপনার ফোন নম্বর লিখুন",
        ...
        "signup.idInvalidChars": "ফোন নম্বরে শুধুমাত্র ইংরেজি অক্ষর এবং সংখ্যা থাকতে হবে",
        ...
        "country.indonesia": "ইন্দোনেশিয়া",
    ...
    en: {
        ...
        "login.idLabel": "Phone Number",
        "login.idPlaceholder": "Enter your phone number",
        ...
        "signup.idInvalidChars": "Phone Number must contain only English letters and numbers",
    ...
    id: {
        ...
        "login.heading": "Masuk",
        "login.idLabel": "Nomor Telepon",
        "login.idPlaceholder": "Masukkan nomor telepon Anda",
        ...
        "signup.idInvalidChars": "Nomor Telepon hanya boleh berisi huruf Inggris dan angka",
